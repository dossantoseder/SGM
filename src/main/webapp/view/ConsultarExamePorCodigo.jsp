    ...
    <body>
        ...
        <div class="jumbotron">
            <div class="container text-center">
                <p>Consultar Exame por Código</p>
            </div>
            <div class="container">
                <form action="ConsultarBebida" method="get">  
                    <div class="form-group row">
                        <label for="txtCodExame" class="col-sm-2 form-control-label">Código do Exame</label>
                        <%-- <% ProdutoBebida bebida = (ProdutoBebida) request.getAttribute("bebida");%> --%>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="txtCodExame" describedby="basic-addon2">
                        </div>
                    </div>                 
