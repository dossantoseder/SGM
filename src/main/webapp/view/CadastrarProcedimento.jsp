<%-- 
    ...
    Created on : Jun 2, 2016, 10:08:54 AM
    Author     : Logan
--%>
            ...
            <div class="container">
                <form action="CadastrarProcedimento" method="post">  
                    <div class="form-group row ">
                         <div class="col-md-6">            
                            <label for="txtCodigoProcedimento" class="col-sm-2 form-control-label">Código</label>
                            <div class="col-sm-6">
                    ...
                    <div class="form-group row ">                     
                         <div class="col-md-6">            
                            <label for="txtTipoProcedimento" class="col-sm-2 form-control-label">Tipo</label>
                            <div class="col-sm-6">
                                <input type="text" maxlength="9" class="form-control" name="txtTipoProcedimento">
                            </div>                        
                        </div>
                        <div class="col-md-6">            
